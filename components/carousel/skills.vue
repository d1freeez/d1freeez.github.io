  ...
  <div class="carousel">
    <swiper ref="mySwiper" :options="swiperOptions">
      <swiper-slide v-for="(item, index) in data" :key="index">
        <div class="_list">
          <div class="_card" v-for="value in item" @click="onLink(value['id'])">
            <img v-if="value['respond_file_path'] === null" src="@/assets/images/card.png" alt="">
            <img v-else :src='value["respond_file_path"]' alt="images">
            <p>{{ value['name'] || '...' }}</p>
          </div>
        </div>
      </swiper-slide>
