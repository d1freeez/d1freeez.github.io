<template>
  <div>
    <div class="all container">
      <div class="skills">
        <div class="_title"><p>Мои покупки</p></div>
...
export default {
  ...
  created () {
    this.$store.dispatch('my_course/setPaidCourse', this.type);
  },

  methods:{
    onProcess(type){
      this.type = type;
      this.$store.dispatch('my_course/setPaidCourse', type);
    },
  },

  computed:{
    ...mapGetters({
      course: 'my_course/paid',
    })
  },
}
</script>
